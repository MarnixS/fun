...
function init(){
 ...
 const nemesisLink=nav.querySelector('a[href="nemesis.html"]');
 if(nemesisLink)nemesisLink.addEventListener('click',e=>{e.preventDefault();window.location.assign('nemesis.html')});
