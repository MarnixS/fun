...
function itemRow(m){
 ...
 const rank=meaningfulRank(m,z),imp=rank.imp,contribution=rank.score;
 const modifiers=[];
...
function ranked(metrics){
 return metrics.map(m=>{
  ...
  const rank=meaningfulRank(m,z);return{...m,imp:rank.imp,meaningfulRank:rank,sort:rank.score}
