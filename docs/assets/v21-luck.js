...
const COMMUNITY_RULES=[
 ...
 {w:6.0,label:'core Ironman jewellery progression ingredient',kind:'major-shareable',re:/^zenyte shard$/i},
 {w:4.1,label:'major melee upgrade',kind:'shareable',re:/^(avernic defender hilt|araxtye fang|araxyte fang|primordial crystal)$/i},
